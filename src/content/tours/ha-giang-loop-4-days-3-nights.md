...
en:
  ...
  inclusions: ["Local rider or self-drive bike", "3 nights homestay", "Meals on tour", "Fuel"]
  exclusions: ["Transport to Ha Giang", "Personal travel insurance", "Tips"]
  faq:
    - { q: "What's different about the 4-day tour?", a: "It adds the quieter Du Gia valley and the northernmost point at Lung Cu — the deepest, most complete version of the loop." }
  ...
  seoTitle: "4 Days 3 Nights Ha Giang Loop Tour | Tien Tour"
  seoDesc: "The full 4-day Ha Giang Loop: Du Gia valley, Lung Cu, Ma Pi Leng, Nho Que river and three homestay nights. Easy rider or self-drive, small groups, 5.0★."
fr:
  title: "Circuit boucle de Ha Giang 4 jours – 3 nuits"
  ...
  inclusions: ["Pilote local ou moto self-drive", "3 nuits chez l'habitant", "Repas pendant le tour", "Essence"]
  exclusions: ["Transport jusqu'à Ha Giang", "Assurance voyage personnelle", "Pourboires"]
  faq:
    - { q: "Qu'apporte le circuit de 4 jours ?", a: "Il ajoute la vallée plus calme de Du Gia et le point le plus au nord à Lung Cu — la version la plus complète de la boucle." }
  ...
  seoTitle: "Circuit boucle de Ha Giang 4 jours 3 nuits | Tien Tour"
  seoDesc: "La boucle complète en 4 jours : vallée de Du Gia, Lung Cu, Ma Pi Leng, Nho Què et trois nuits chez l'habitant. Easy rider ou self-drive, petits groupes, 5,0★."
---
